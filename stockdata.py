...
# THIS FILE CHECKS fetch_


def get_api_key(filepath):
    """
    Read the Alpha Vantage API key from txt file.
    """
...
def create_db_and_table(db_name, table_name):
    """
    Create db, date tracker table, and stock data table.
    """
...
def insert_weekly_data(db_name, table_name, data, n=25):
    """
    Insert the next n weekly data points, pull starting point from date table.
    """
    conn = sqlite3.connect(db_name)
    cur = conn.cursor()
