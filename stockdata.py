...
def pull_data_from_api(api_key, symbol, data_type):
    import requests
...
def insert_data_into_db(db_name, table_name, data):
    conn = sqlite3.connect(db_name)
    cur = conn.cursor()
...
if __name__ == "__main__":
    ...
    insert_data_into_db(db_name, table_name, pull_data_from_api(api_key, ticker, data_type))
